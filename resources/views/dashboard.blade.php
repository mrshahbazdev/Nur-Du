        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-lg font-semibold text-gray-900">Vision Statement</h3>
                        <a href="{{ route('vision.index') }}" class="text-sm text-indigo-600 hover:text-indigo-800">Manage &rarr;</a>
                    </div>
                    @if($vision)
                        ...
                        @if($vision->guidingPrinciples->count())
                            <div class="mt-4">
                                <p class="text-sm font-medium text-gray-500 mb-2">Guiding Principles:</p>
                        ...
                        @endif
                    @else
                        <p class="text-gray-500">No vision defined yet. <a href="{{ route('vision.index') }}" class="text-indigo-600 underline">Create one</a>.</p>
                    @endif
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-semibold text-gray-900">{{ $currentQuarter }} {{ $currentYear }} Focus</h3>
                            <a href="{{ route('quarterly.index') }}" class="text-sm text-indigo-600 hover:text-indigo-800">All Quarters &rarr;</a>
                        </div>
                                ...
                                @foreach($quarterlyFocus->strategicPriorities as $priority)
                                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                        <div>
                                            ...
                                            @if($priority->owner)
                                                <p class="text-sm text-gray-500">Owner: {{ $priority->owner }}</p>
                                            @endif
                                        </div>
                        ...
                        @else
                            <p class="text-gray-500">No priorities set for this quarter. <a href="{{ route('quarterly.index') }}" class="text-indigo-600 underline">Set them now</a>.</p>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-semibold text-gray-900">Decision Alignment</h3>
                            <a href="{{ route('decisions.index') }}" class="text-sm text-indigo-600 hover:text-indigo-800">All Decisions &rarr;</a>
                        </div>
                        ...
                        @if($total > 0)
                            <div class="flex items-center space-x-4 mb-4">
                                <div class="flex-1 text-center">
                                    ...
                                    <div class="text-sm text-gray-500">Aligned</div>
                                </div>
                                <div class="flex-1 text-center">
                                ...
                                <div class="flex-1 text-center">
                                    ...
                                    <div class="text-sm text-gray-500">Misaligned</div>
                                </div>
                            </div>
                        ...
                        @else
                            <p class="text-gray-500">No decisions logged yet. <a href="{{ route('decisions.create') }}" class="text-indigo-600 underline">Log one</a>.</p>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Recent Decisions</h3>
                        ...
                        @else
                            <p class="text-gray-500">No decisions yet.</p>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-semibold text-gray-900">Latest Vision Check</h3>
                            <a href="{{ route('checks.create') }}" class="text-sm text-indigo-600 hover:text-indigo-800">New Check &rarr;</a>
                        </div>
                        @if($latestCheck)
                            <p class="text-sm text-gray-500 mb-3">{{ $latestCheck->check_date->format('M d, Y') }}</p>
                            <div class="space-y-2">
                                <div class="flex items-center space-x-2">
                                    <span class="text-sm font-medium text-gray-700">Paying into vision?</span>
                                    <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium
                                        ...
                                        {{ ucfirst($latestCheck->q1_answer) }}
                                    </span>
                                </div>
                                @if($latestCheck->actionItems->count())
                                    <div class="mt-3">
                                        <p class="text-sm font-medium text-gray-500">Action Items:</p>
                        ...
                        @else
                            <p class="text-gray-500">No vision checks yet. <a href="{{ route('checks.create') }}" class="text-indigo-600 underline">Start one</a>.</p>
                        @endif
                    </div>
                </div>
            </div>
